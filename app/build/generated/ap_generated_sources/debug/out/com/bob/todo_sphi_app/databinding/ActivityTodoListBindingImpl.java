...
public class ActivityTodoListBindingImpl extends ActivityTodoListBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.rv_todo_list, 1);
    ...
    public ActivityTodoListBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 3, sIncludes, sViewsWithIds));
    }
    private ActivityTodoListBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
